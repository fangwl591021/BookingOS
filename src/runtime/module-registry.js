export const MODULES = Object.freeze([
  ...
  { id: "booking", version: "0.2.0", status: "partial", routes: ["/api/bookings", "/api/availability"], capabilities: ["booking.create", "booking.read"], dependencies: ["weekly-hours", "service", "staff"] },
  { id: "weekly-hours", version: "0.1.0", status: "active", routes: [], capabilities: ["schedule.read"], dependencies: [] },
  { id: "staff", version: "0.2.0", status: "partial", routes: ["/api/staff"], capabilities: ["staff.read", "staff.write"], dependencies: [] },
  { id: "service", version: "0.2.0", status: "partial", routes: ["/api/services"], capabilities: ["service.read", "service.write"], dependencies: [] },
