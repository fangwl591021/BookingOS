...
async function convertTrialTenant(request, env) {
  ...
  try {
    ...
    const contractEnd = String(payload.contractEnd || "").trim() || addDays(contractStart, status === "trial" ? 14 : 365);
    const plan = planFromPayload(payload);
